...
const services = [
  {
    ...
    description:
      "Regular check-ups and preventative treatments to keep your pets healthy.",
    icon: PawPrint,
  },
  {
    id: "vaccinations",
    title: "Vaccinations",
    description:
      "Essential vaccines to protect your pets against common diseases.",
    icon: Syringe,
  },
  {
    id: "surgery",
  ...
  },
  {
    ...
    title: "Pet Grooming",
    description:
      "Professional grooming services to keep your pets clean and healthy.",
    icon: Scissors,
  },
  {
    id: "kennel",
    ...
    description:
      "Safe and comfortable accommodation for your pets while you're away.",
    icon: Dog,
  },
];
          ...
          <div className="lg:col-span-4">
            <AnimatedElement variant="slideUp">
              ...
              <p className="text-gray-600 mb-6">
                ...
                Our team of experienced veterinarians and staff are dedicated to
                ...
                >
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="text-xl font-semibold text-vet-dark mb-2 group-hover:text-vet-teal transition-colors">
                          {service.title}
                        </h3>
                        ...
                        <Link
                          ...
                          className="text-vet-blue hover:text-vet-teal font-medium transition-custom inline-flex items-center"
                        >
