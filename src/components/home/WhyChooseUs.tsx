...
const features = [
  {
    ...
    title: "Trusted Care",
    description:
      "Our team of experienced veterinarians provides trusted, reliable care for your pets.",
  },
  {
    icon: Clock,
    title: "Emergency Services",
    description:
      "We offer emergency veterinary services when your pet needs urgent medical attention.",
  },
  {
    icon: Award,
    title: "Quality Assurance",
    description:
      "We maintain the highest standards of veterinary practice and pet care.",
  },
  {
    icon: Heart,
    title: "Compassionate Approach",
    description:
      "We treat your pets with the love and compassion they deserve.",
  },
  {
    icon: Users,
    title: "Expert Team",
    description:
      "Our staff includes specialists in various aspects of veterinary medicine.",
  },
  {
    icon: Stethoscope,
    title: "Modern Equipment",
    description:
      "We use state-of-the-art equipment for diagnosis and treatment.",
  },
];
          ...
          <div className="lg:col-span-5">
            <AnimatedElement variant="slideUp">
              ...
              <h2 className="text-3xl md:text-4xl font-display font-bold mb-6 text-vet-dark">
                Providing <span className="text-vet-teal">Best Care</span> For
                Your Beloved Pets
              </h2>
              <p className="text-gray-600 mb-8">
                At Koney's Veterinary Hospital, we understand that your pets are
                family members. That's why we provide comprehensive,
                compassionate care to ensure their health and happiness.
              </p>
