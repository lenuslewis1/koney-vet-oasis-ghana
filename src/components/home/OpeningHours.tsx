          ...
          <div className="lg:col-span-5">
            <AnimatedElement variant="slideUp" delay={0.2}>
              ...
              <p className="text-gray-600 mb-8">
                We are available to care for your pets during the following
                hours. For emergencies outside these hours, please call our
                emergency line.
              </p>
                ...
                <div className="divide-y divide-gray-100">
                  {hours.map((item, index) => (
                    ...
                    >
                      ...
                      <span className="text-vet-blue font-semibold">
                        {item.hours}
                      </span>
                    </div>
                  ))}
