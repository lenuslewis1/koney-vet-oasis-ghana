  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      try {
        ...
        if (!response.ok) {
          console.warn(
            "Notification service returned an error, but form was submitted successfully"
          );
        }
      } catch (notificationError) {
        console.warn(
          "Failed to send notification, but form was submitted successfully:",
          notificationError
        );
      }
            ...
            <div>
              ...
              <div className="space-y-6 mb-8">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-vet-dark mb-1">
                      Phone
                    </h3>
