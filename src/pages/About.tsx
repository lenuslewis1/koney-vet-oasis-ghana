...
const teamMembers = [
  ...
  },
  {
    ...
    image:
      "https://res.cloudinary.com/dzmvzdcpx/image/upload/v1747825782/_MG_2360_kwud6f.jpg",
  ...
  },
  {
    ...
    image:
      "https://res.cloudinary.com/dzmvzdcpx/image/upload/v1747825783/_MG_2183_rescny.jpg",
  ...
  },
  {
    ...
    image:
      "https://res.cloudinary.com/dzmvzdcpx/image/upload/v1748531489/_MG_2275_fvv69y.jpg",
  ...
  },
  {
    ...
    role: "Pet Groomer",
    image:
      "https://res.cloudinary.com/dzmvzdcpx/image/upload/v1748531489/_MG_2257_uf5age.jpg",
  ...
  },
  {
    ...
    image:
      "https://res.cloudinary.com/dzmvzdcpx/image/upload/v1748531490/_MG_2152_hateck.jpg",
  ...
  },
  {
    ...
    role: "Veterinary Nurse",
    image:
      "https://res.cloudinary.com/dzmvzdcpx/image/upload/v1747825782/_MG_2461_k0ax0y.jpg",
    bio: "Akosua has been with us since our founding and leads our nursing team with compassion and expertise.",
  },
  {
    id: 5,
    ...
    role: "Pet Groomer",
    image:
      "https://res.cloudinary.com/dzmvzdcpx/image/upload/v1748526045/_MG_2218_cze6jq.jpg",
    bio: "Kofi is a certified pet groomer with a special talent for handling anxious pets.",
  },
  {
    id: 6,
              ...
              <AnimatedElement variant="slideUp" delay={0.2}>
                ...
                <div className="space-y-4">
                  <p className="text-gray-700">
                    Founded in 2010 by Dr. Samuel Koney, our veterinary hospital
                    has grown from a small clinic to a comprehensive pet care
                    center serving the greater Accra area. What started as a
                    dream to provide quality veterinary care in Ghana has
                    evolved into a state-of-the-art facility with a team of
                    dedicated professionals.
                  </p>

                  <p className="text-gray-700">
                    Our mission is simple: to provide exceptional veterinary
                    care with compassion and expertise. We believe that pets are
                    family members who deserve the same level of medical
                    attention and care as humans, and we work tirelessly to
                    ensure their health and happiness.
                  </p>

                  <p className="text-gray-700">
                    Over the years, we've expanded our services to include not
                    just medical care but also grooming, boarding, and a
                    comprehensive pet shop to meet all your pet needs in one
                    place.
                  </p>
                </div>
              ...
              <div className="text-center mb-12">
                <AnimatedElement variant="fadeIn">
                  ...
                  <p className="text-gray-600 max-w-2xl mx-auto">
                    These principles guide everything we do at Koney's
                    Veterinary Hospital, ensuring the highest quality care for
                    your pets.
                  </p>
                </AnimatedElement>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
                <AnimatedElement variant="fadeIn" delay={0.1}>
                  ...
                  >
                    ...
                    <p className="text-gray-600">
                      We treat every pet with the love and attention they
                      deserve, understanding the special bond between pets and
                      their owners.
                    </p>
                ...
                <AnimatedElement variant="fadeIn" delay={0.2}>
                  ...
                  >
                    ...
                    <p className="text-gray-600">
                      We commit to ongoing education and investing in modern
                      equipment to provide the highest standard of veterinary
                      medicine.
                    </p>
                    <ul className="mt-4 space-y-2">
                      <li className="flex items-center gap-2">
                ...
                <AnimatedElement variant="fadeIn" delay={0.3}>
                  ...
                  >
                    ...
                    <p className="text-gray-600">
                      We believe informed pet owners make better decisions, so
                      we take time to educate and guide you through your pet's
                      health journey.
                    </p>
                    <ul className="mt-4 space-y-2">
                      <li className="flex items-center gap-2">
          ...
          <div className="mb-20">
            <div className="text-center mb-12">
              <AnimatedElement variant="fadeIn">
                ...
                <p className="text-gray-600 max-w-2xl mx-auto">
                  Our team of experienced veterinarians and staff are dedicated
                  to providing the highest quality care for your pets.
                </p>
              </AnimatedElement>
            </div>
                ...
                >
                  ...
                  >
                    ...
                    <div className="p-6 relative">
                      ...
                      <h3 className="text-xl font-semibold text-vet-dark group-hover:text-vet-teal transition-colors">
                        {member.name}
                      </h3>
                      <p className="text-vet-coral font-medium mb-3">
                        {member.role}
                      </p>
